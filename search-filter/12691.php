...
{
	?>
	<div class="archivecontainer padtop30">
		...
		<?php
			while ($query->have_posts())
			{
				...
				<?php } else { ?>
						<article style="opacity: 0.6;" class="archiveitem" id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
							<?php if ( has_post_thumbnail() ) : ?>
								<div class="archiveitemimage">
							...
							<?php endif; ?>
								<div class="archiveitemcontent">
									<img src="/wp-content/themes/beingboss2018/img/BBClubhouse_SecretEpisodes.png">
									<h5><span class="archiveitemtitle"> <?php the_title(); ?></span></h5>
									<a class="archiveitemreadmore upper">COMING <?php echo get_the_date( 'M j' ); ?></a>
								</div> 
						</article>
				<?php 	} 	
			}
