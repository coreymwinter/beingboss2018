				...
				<article class="archiveitem worksheets" id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
					<div class="archiveitemimage">
						<?php if ( has_post_thumbnail() ) : ?>
							<a href="<?php echo $material_link; ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail('archive-thumb'); ?></a>
						<?php endif; ?>
					</div>
					<div class="archiveitemcontent">
						...
						<a href="<?php echo $material_link; ?>" class="button-yellow">Download Now</a>
					</div> 
				</article>
			<?php } else { ?>
				<article class="archiveitem worksheets" id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
