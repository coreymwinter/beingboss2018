		...
		<div class="col-md-8" style="margin: 0 auto;">
			<div class="top-subscribe">
				<div class="inner">
					...
					<?php if ( !empty( $webinar_full_everwebinar ) ) { ?>
						<?php echo $webinar_full_everwebinar; ?>
					<?php } else { ?>
						<a href="<?php echo $webinar_button_link; ?>" target="_blank" class="button-yellow"><?php echo $webinar_button_label; ?></a>
					<?php } ?>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-8" style="padding: 0 40px;">
				...
				<?php if ( !empty( $webinar_full_everwebinar ) ) { ?>
					<?php echo $webinar_full_everwebinar; ?>
				<?php } else { ?>
					<a href="<?php echo $webinar_button_link; ?>" target="_blank" class="button"><?php echo $webinar_button_label; ?></a>
				<?php } ?>
			</div>
