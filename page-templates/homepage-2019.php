						...
						<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
							...
							<header class="entry-header">
								...
								<div class="headersection">
									<a class="home-header-link" href="/quiz/ceo"></a>
									<div class="container">
										<div class="headertext">
											<div class="row align-items-center">
												<div class="col-md-12 headertext">
													<a href="/quiz/ceo">
														<p class="brandon giant white">BE THE BOSS<br />OF YOUR BUSINESS</p>

														<p class="white medium brandon">DISCOVER YOUR CEO STYLE</p>
													</a>
													<a class="button-yellow" href="/quiz/ceo">TAKE THE QUIZ >></a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="container" id="homepodcasts">
										<div class="padtop15 padbot30">
											<div class="row">
												...
												<div class="col-md-4"><a href="/10minutes"><img src="/wp-content/themes/beingboss2018/img/BB_Logo_10Minutes_Optimized.jpg"></a></div>
								...
								<div class="container pagesection80">
									<div class="discoversection">
										<div class="capsule pagesection50">
											<div class="row">
												<div class="col-lg-5">
													<div style="display: table; margin: -100px auto 50px;"><img src="/wp-content/themes/beingboss2018/img/StartHere_Optimized.jpg"></div>
												...
												<div class="col-lg-7">
													...
													<div class="episodelist padbot30">
														<div class="episodeitem"><div class="itemleft podcast"></div><div class="itemright"><a href="/podcast/episode-79-chalkboard-method" target="_blank">EPISODE #79 // Goal Setting: The Chalkboard Method</a></div></div>
														<div class="episodeitem"><div class="itemleft podcast"></div><div class="itemright"><a href="/podcast/podcast-episode-2-freaking-out-about-money" target="_blank">EPISODE #2 // What to Do When You're Freaking Out About Money</a></div></div>
														<div class="episodeitem"><div class="itemleft podcast"></div><div class="itemright"><a href="/podcast/episode-94-money-mindset" target="_blank">EPISODE #94 // Money Mindset</a></div></div>
														<div class="episodeitem"><div class="itemleft podcast"></div><div class="itemright"><a href="/podcast/podcast-episode-48-boss-integrity-jay-pryor" target="_blank">EPISODE #48 // Boss Integrity with Jay Pryor</a></div></div>
														<div class="episodeitem"><div class="itemleft podcast"></div><div class="itemright"><a href="/podcast/minisode-productive-workspace" target="_blank">MINISODE // How to Set Up a Productive Workspace</a></div></div>
													</div>
													<h3 class="xxmedium">ARTICLES</h3>
													<div class="episodelist">
														<div class="episodeitem"><div class="itemleft article"></div><div class="itemright"><a href="/articles/chalkboard-method-goal-setting" target="_blank">The Chalkboard Method for Goal Setting</a></div></div>
														<div class="episodeitem"><div class="itemleft article"></div><div class="itemright"><a href="/articles/manifesting-business-word" target="_blank">Manifesting Can Be a Business Word</a></div></div>
													</div>
												</div>
											</div>
										</div>
