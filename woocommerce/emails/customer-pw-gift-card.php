...
<style type="text/css">
    ...
    #pwgc-email-gift-card-container {
        ...
        text-align: center;
	    background-image: url('https://beingboss.club/wp-content/uploads/2018/02/Back_Smoke_1.jpg');
...
<table id="pwgc-email-gift-card-container" height="275" width="100%">
    ...
    <tr>
        <td width="10"></td>
        <td>
            <div id="pwgc-email-redeem-button" style="background-color: #FFF200;">
                <a href="<?php echo $item_data->redeem_url; ?>" style="color: #252525;"><?php _e( 'Redeem', 'pw-woocommerce-gift-cards' ); ?></a>
            </div>
        </td>
        <td width="10"></td>
    </tr>
